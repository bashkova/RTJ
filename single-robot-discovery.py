...
def main():
    ...
    for part_idx in range(3):
        try:
            ...
            epde_search_obj_system.set_moeadd_params(training_epochs = 50)
            ...
            #    loader.save(obj=temp, filename=equations_path)
            #    print(f"Saved equations: {equations_path}")
            #
            # print(epde_search_obj_system.pool)
            #
